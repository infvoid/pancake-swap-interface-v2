...
import { Flex, LinkExternal, Text, Tag, CheckmarkCircleIcon } from '@pancakeswap-libs/uikit'
    ...
    <Row>
      <AddressColumn>
        <Flex alignItems="center">
          <LinkExternal href={getBscScanLink2(vote.voter, 'address')}>{truncateWalletAddress(vote.voter)}</LinkExternal>
          {isVoter && (
