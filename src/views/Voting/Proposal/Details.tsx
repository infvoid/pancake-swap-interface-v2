...
import { Box, Card, CardBody, CardHeader, Flex, Heading, LinkExternal, Text } from '@pancakeswap-libs/uikit'
import styled from 'styled-components'
import { format } from 'date-fns'
import { Proposal } from 'state/types'
import { useTranslation } from 'hooks/useI18n'
import { getBscScanLink2 } from 'utils'
    ...
    <Card mb="16px">
      ...
      <CardBody>
        ...
        <Flex alignItems="center" mb="8px">
          ...
          <LinkExternal href={getBscScanLink2(proposal.author, 'address')} ml="8px">
            {truncateWalletAddress(proposal.author)}
          </LinkExternal>
        </Flex>
        <Flex alignItems="center" mb="16px">
          <Text color="textSubtle">{t('Snapshot')}</Text>
          <LinkExternal href={getBscScanLink2(proposal.snapshot, 'block')} ml="8px">
            {proposal.snapshot}
          </LinkExternal>
        </Flex>
        <DetailBox p="16px">
